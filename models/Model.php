...
function goods_new($connect, $nameShort, $nameFull, $price,  $bigPhoto, $miniPhoto)
{
    $t = "INSERT INTO goods ( nameFull, price,  bigPhoto, miniPhoto) VALUES ('%s', '%s','%s','%s','%s','%s')";
...
{
    $query = "INSERT INTO `goods` (`id`,  `nameFull`, `price`,  `bigPhoto`, `miniPhoto`,   `stickerHit`, `views`) VALUES (NULL, '', '', '', '', '', '', '', '', '', '', '');";
...
function goods_edit($connect, $id, $nameShort, $nameFull, $price, $param, $bigPhoto, $miniPhoto, $weight, $discount,  $stickerFit, $stickerHit)
{
    ...
    $sql = "UPDATE goods SET nameFull='%s', price='%s',bigPhoto='%s',miniPhoto='%s' WHERE id='%d'";
